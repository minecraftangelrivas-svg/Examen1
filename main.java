...
public class main {
    ...
    public static double pRetiro(Scanner entrada, double saldo, double comision) {// retiro con comision
        double retiro;
        System.out.println("Ingrese el monto a retirar (Red Externa):");//red externa por el metodo que se refiere al de la comision
        retiro = entrada.nextDouble();
    ...
    public static void main(String[] args) {
        ...
        do{
            ...
            switch (opcion) {
                ...
                case 4:
                    // Llamada a la versión sobrecargada de 3
